...
class LoginScreen extends HTMLElement {
	...
	async handleLogin(event: Event) {
		...
		const emailElement = this.shadowRoot?.querySelector('username-field') as unknown as UsernameField;
		const passwordElement = this.shadowRoot?.querySelector('password-field') as unknown as PasswordField;
     ...
     <style>
        ${styles}
			...
			<div class="login-container">
				<!-- Colocamos el intro-banner arriba del modal de login -->
